  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      if (currentChecklist !== undefined) {
        await axios
          .put(
            `https://checklist.pmcweb.vn/demo/api/ent_checklist/update/${currentChecklist.ID_Checklist}`,
            data,
            {
              headers: {
        ...
        axios
          .post(`https://checklist.pmcweb.vn/demo/api/ent_checklist/create`, data, {
            headers: {
              Accept: 'application/json',
              Authorization: `Bearer ${accessToken}`,
            },
