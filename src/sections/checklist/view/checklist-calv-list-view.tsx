...
export default function ChecklistCalvListView() {
  ...
  const handleDeleteRow = useCallback(
    async (id: string) => {
      await axios
        .put(`https://checklist.pmcweb.vn/demo/api/ent_checklist/delete/${id}`, [], {
          headers: {
  ...
  const handlePrint = useCallback(async () => {
    try {
      ...
      const response = await axios.post('https://checklist.pmcweb.vn/demo/api/tb_checklistc/baocao', data, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
  ...
  const handleOpenChecklistC = useCallback(
    async (id: string) => {
      await axios
        .put(`https://checklist.pmcweb.vn/demo/api/tb_checklistc/open/${id}`, [], {
          headers: {
            Accept: 'application/json',
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const handleRemoveChecklistC = useCallback(
    async (id: string) => {
      await axios
        .put(`https://checklist.pmcweb.vn/demo/api/tb_checklistc/delete/${id}`, [], {
          headers: {
            Accept: 'application/json',
            Authorization: `Bearer ${accessToken}`,
          },
