  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      if (currentCycle !== undefined) {
        await axios
          .put(`https://checklist.pmcweb.vn/demo/api/ent_duan_khoicv/update/${currentCycle.ID_Duan_KhoiCV}`, data, {
            headers: {
        ...
        axios
          .post(`https://checklist.pmcweb.vn/demo/api/ent_duan_khoicv/create`, data, {
            headers: {
              Accept: 'application/json',
              Authorization: `Bearer ${accessToken}`,
            },
